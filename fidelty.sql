...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-11-2022 a las 04:43:58
...
(16, '2022-11-04', 5000, '20-44006022-7', 44006022),
(17, '2022-11-04', 10000, '20-44006022-7', 44006022),
(18, '2022-11-04', 1200, '20-44006021-7', 44006022);
...
(23, 2600, 398, 10, 'http://res.cloudinary.com/hdsqazxtw/image/upload/v1570710978/coderhouse.jpg', 'Beca CoderHouse', 'Descuento en la plataforma CoderHouse en cualquier curso a elección cuyo valor sea menor a $10000 del 50%', 'La Distribuidora SA'),
...
(49, 100, 20, 25, 'https://tienda.pago24.com.ar/media/catalog/product/cache/8bba2abe6d282ec93669d82aeb928040/l/f/lf28.jpeg', 'Alfajor Pepitos triple x65g', 'Canjeable por un descuento del 100% en Alfajor Pepito triple x65g en Wabi. Aplicable en compras superiores a $700 de lunes a jueves.', 'Wabi');
...
(44006022, 'Agustín', 'Fernandez', '2002-01-17', 'af.agusfernandez02@gmail.com', 'd006a21a31dcb74a9531c14adef78621', 5000);
...
--
ALTER TABLE `canjes`
  MODIFY `id_canje` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `pedidos_reposicion`
  MODIFY `id_pedido` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `remitos`
  MODIFY `id_remito` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
COMMIT;
